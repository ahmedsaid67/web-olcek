      ...
      <div className={styles.pageContainer}>
        ...
        <div className={styles.pageCenterContainer}>
            ...
            <div className={styles.TanitimContainer}>
                ...
                <p className={styles.TanitimContainerDetailText}>Ölçek ile İlaç dozlarınızı kolayca hesaplayın, besin takviyelerinizin dozlarına hızla ulaşın! Hatırlatma özelliğiyle sağlığınızı güvenle koruyun. <Link href="/indir"><strong>Hemen indirin!</strong></Link></p>
                <Link href="/indir">
