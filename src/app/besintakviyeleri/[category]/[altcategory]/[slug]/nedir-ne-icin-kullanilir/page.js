...
async function getProductDetail(slug) {
  try {
    ...
    if (error.response && error.response.data.detail.includes("Belirtilen slug ile eşleşen bir ürün bulunamadı.")) {
      throw new Error("Aradığınız besin takviyesi sistemimizde mevcut değil. Lütfen doğru ismi yazdığınızdan emin olun.")
    } else {
      // Genel hata
      console.log("Bir şeyler ters gitti, daha sonra tekrar deneyiniz.")
